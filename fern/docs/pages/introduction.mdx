...
<Steps>
  ...
  Visit [brzip.com.br/abrasuaconta](https://brzip.com.br/abrasuaconta) and fill out the account opening form. Once your account is approved, you will receive your API credentials via email.

  ### Step 2 — Generate Bearer Token
  With your credentials, generate your Bearer Token with `POST /v1/auth/bearer-token`.

  ### Step 3 — Register a PIX Key
