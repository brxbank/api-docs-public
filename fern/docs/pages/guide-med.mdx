...
```bash
curl -X GET "https://pix-api.brzip.com.br/api/v1/pix/med/status/OPEN?page=1&page_size=20" \
...
```bash
curl -X POST https://pix-api.brzip.com.br/api/v1/pix/med/<med-id>/respond \
  -H "Authorization: Bearer <your-jwt>" \
