...
Subscribe to the `pix.med_refund.received` event to be notified in real time when a new MED request arrives. See the [Webhooks Integration](/guides/webhooks-integration) guide for setup instructions.
